...
import image from '../../../Assets/images/Corporate/corporate8.png'
const CorporateService_8 = () => {
  return (
    <div>
        <Message 
        image={image} text={"Advertising Services"}
        head={"Corporate"} address={"Advertising Services"}
...
export default CorporateService_8