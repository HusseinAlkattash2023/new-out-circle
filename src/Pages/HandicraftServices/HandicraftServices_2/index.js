...
import image from '../../../Assets/images/Handicraft/handicraft2.png'
const HandicraftServices_2 = () => {
  return (
    <div>
        <Message 
        image={image} text={"New business advice and ideas"}
        head={"Handicraft"} address={"New business advice and ideas."}
...
export default HandicraftServices_2