...
import image1 from '../../../Assets/images/handicraft-ar/image5.png'
const HandicraftServiceAr_5 = () => {
  return (
    <div>
        <MessageAr 
        image={image1} text={"خدمات (عقارات ، مواصلات ، مالية ، سجل تجاري .. إلخ)"}
        head={"حرفيين"} address = {"خدمات (عقارات ، مواصلات ، مالية ، سجل تجاري .. إلخ)"}
        text1={"متابعة معاملات الدوائر العقارية والمالية والبلدية"}
        text2={"متابعة معاملات السجل التجاري والشوؤن الاجتماعية"}
...
export default HandicraftServiceAr_5;