...
import image1 from '../../../Assets/images/Institute/institute8.png'
const InstituteService_8 = () => {
  return (
    <div>
        <Message 
        image={image1} text={"Advertising Services."}
...
export default InstituteService_8