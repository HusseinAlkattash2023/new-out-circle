...
import image1 from '../../../Assets/images/Institute_ar/image5.png'
const InstituteServiceAr_5 = () => {
  return (
    <div>
        <MessageAr 
        image={image1} text={"خدمات (عقارات ، مواصلات ، مالية ، سجل تجاري .. إلخ)"}
        head={"مؤسسة"} address = {"خدمات (عقارات ، مواصلات ، مالية ، سجل تجاري .. إلخ)"}
...
export default InstituteServiceAr_5;